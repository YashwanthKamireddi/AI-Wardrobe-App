...
import { Plus, Search, Grid3X3, LayoutList, X, Edit, Trash2, Sparkles, Loader2, Wand2, User, Layers, Heart, Filter } from "lucide-react";
      ...
      <nav className="sticky top-0 z-50 bg-[#F9F9F7]/95 backdrop-blur-xl border-b border-[#E5E5E5]/50">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link href="/wardrobe">
              <span className="text-xs tracking-[0.15em] uppercase text-[#1A1A1A] font-medium">Wardrobe</span>
            </Link>
            <Link href="/outfits">
        ...
        >
          <div className="flex gap-4">
            ...
            <motion.button
              ...
              className={`h-12 px-5 rounded-full flex items-center gap-2 text-sm font-medium transition-all ${
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-xl border-t border-[#E5E5E5]/50 px-6 py-3">
        <div className="flex items-center justify-around">
          {[
            ...
            { href: "/wardrobe", icon: Layers, label: "Wardrobe", active: true },
