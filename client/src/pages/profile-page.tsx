...
import {
  ...
  Bell, Moon, Sun, Palette, Eye, Lock, HelpCircle, MessageSquare,
        ...
        <header className="mb-10">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ background: `${burgundy}10` }}>
              <User className="h-5 w-5" style={{ color: burgundy }} />
            </div>
            <div>
              <h1 className="font-serif text-3xl md:text-4xl text-slate-900">Your Profile</h1>
              <p className="text-slate-400 text-sm">Manage your account and style journey</p>
            </div>
          </div>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <Card className="border-slate-100 bg-white shadow-sm overflow-hidden">
              <CardHeader className="text-center relative pb-4">
                ...
                <div className="relative flex justify-center mb-4 pt-8">
                  <div
                    className="h-24 w-24 rounded-full flex items-center justify-center text-3xl font-serif shadow-xl border-4 border-white relative"
                ...
                {/* Member Badge */}
                <Badge className="mt-2 rounded-full" style={{ background: `${gold}20`, color: burgundy }}>
              ...
              <CardContent className="space-y-5">
                {/* Level Progress */}
                <div className="p-4 rounded-xl" style={{ background: `${burgundy}05` }}>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    <div key={idx} className="text-center p-3 border border-slate-100 rounded-xl hover:border-slate-200 transition-colors">
                ...
                <div className="space-y-3">
                  {user?.email && (
                    <div className="flex items-center gap-3 text-sm p-3 rounded-xl bg-slate-50">
                ...
                <Button
                  variant="outline"
                  className="w-full rounded-full border-red-200 text-red-600 hover:bg-red-50 hover:border-red-300 transition-all"
                ...
                <Card className="border-slate-100 bg-white shadow-sm">
                  <CardHeader className="pb-3">
                    <div className="flex items-center justify-between">
                      <CardTitle className="font-serif text-lg text-slate-900">Achievements</CardTitle>
                    ...
                    {achievements.map((achievement) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="font-medium text-sm text-slate-900 truncate">{achievement.name}</p>
          ...
          <div className="lg:col-span-2 space-y-6">
            <Tabs defaultValue="style" className="w-full">
              <TabsList className="grid w-full grid-cols-3 mb-6 bg-white border border-slate-200 p-1 rounded-xl">
                <TabsTrigger
                  value="style"
                  className="rounded-lg data-[state=active]:shadow-sm transition-all"
                  style={{
                ...
                <Card className="border-slate-100 bg-white shadow-sm">
                  <CardHeader>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <CardTitle className="font-serif text-xl text-slate-900">Style Profile</CardTitle>
                        <CardDescription>Your unique fashion identity</CardDescription>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent>
              ...
              <TabsContent value="insights">
                <div className="space-y-6">
                  ...
                  <Card className="border-slate-100 bg-white shadow-sm">
                    <CardHeader>
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <CardTitle className="font-serif text-xl text-slate-900">Wardrobe Analysis</CardTitle>
                    ...
                    <CardContent>
                      <div className="grid grid-cols-2 gap-4 mb-6">
                        <div className="p-4 rounded-xl border border-slate-100">
                          ...
                          <p className="text-lg font-semibold text-slate-900 capitalize">{styleInsights.topCategory}</p>
                        </div>
                        <div className="p-4 rounded-xl border border-slate-100">
                          <p className="text-sm text-slate-500 mb-1">Favorite Color</p>
                          <p className="text-lg font-semibold text-slate-900 capitalize">{styleInsights.topColor}</p>
                        </div>
                      </div>
                  ...
                  <Card className="border-slate-100 bg-white shadow-sm">
                    <CardHeader>
                      <CardTitle className="font-serif text-lg text-slate-900">Personalized Recommendations</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-3">
                        {[
                          ...
                          <div key={idx} className="flex items-center gap-3 p-3 rounded-xl bg-slate-50 hover:bg-slate-100 transition-colors cursor-pointer group">
                            <rec.icon className="w-4 h-4 text-slate-400" />
              ...
              <TabsContent value="settings">
                <Card className="border-slate-100 bg-white shadow-sm">
                  <CardHeader>
                    <CardTitle className="font-serif text-xl text-slate-900">Preferences</CardTitle>
                    <CardDescription>Customize your Celura experience</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    ...
                    <div className="space-y-4">
                      <h3 className="text-sm font-semibold text-slate-900 flex items-center gap-2">
                        <Eye className="w-4 h-4" style={{ color: burgundy }} />
                        Appearance
                      </h3>
                      <div className="flex items-center justify-between p-4 border border-slate-100 rounded-xl hover:border-slate-200 transition-colors">
                        <div className="flex items-center gap-3">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <Button variant="outline" className="justify-start rounded-xl border-slate-200 hover:border-slate-300">
