...
export function FramingPage() {
  ...
  const handleExport = async () => {
    toast({
      title: "Frame Saved!",
      description: "Your outfit frame has been saved to your gallery.",
    });
  };
  ...
  const handleShare = () => {
    toast({
      ...
      description: "Your outfit frame link has been copied to clipboard.",
    });
  };
      ...
      <nav className="sticky top-0 z-50 bg-[#F9F9F7]/95 backdrop-blur-xl border-b border-[#E5E5E5]/50">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link href="/framing"><span className="text-xs tracking-[0.15em] uppercase text-[#1A1A1A] font-medium">Framing</span></Link>
          ...
          <Link href="/profile">
            <motion.div className="w-10 h-10 rounded-full bg-[#E5E5E5] flex items-center justify-center" whileHover={{ scale: 1.05 }}>
                  ...
                  <div>
                    ...
                    <div className="flex gap-2 overflow-x-auto pb-2">
                      {BACKGROUNDS.map((bg) => (
                        <motion.button
                          key={bg.id}
                          className={`flex-shrink-0 w-12 h-12 rounded-xl border-2 ${bg.preview} ${
                            selectedBackground.id === bg.id ? "border-[#1A1A1A] ring-2 ring-[#1A1A1A]/20" : "border-[#E5E5E5]"
                          }`}
                    ...
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <button
                        className={`text-xs px-3 py-1 rounded-full transition-colors ${
                          showTitle ? "bg-[#1A1A1A] text-white" : "bg-[#E5E5E5] text-[#6B6B6B]"
                        }`}
                      ...
                      {selectedItemsData.map((item, i) => (
                        <div
                          ...
                          className={`relative overflow-hidden ${
                            selectedItemsData.length === 3 && i === 0 ? "row-span-2" : ""
