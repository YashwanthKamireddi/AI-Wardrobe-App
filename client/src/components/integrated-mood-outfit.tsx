      ...
      {isError && (
        <div className="mt-6 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg text-red-800 dark:text-red-300">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="font-medium">Error Generating Recommendations</h3>
          </div>
              ...
              >
                <div className="p-6">
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      <h3 className="font-bold text-xl">{recommendation.outfitName}</h3>
                  ...
                  <motion.div
                    ...
                    className="space-y-4"
                  >
                    <div className="text-base mb-5 p-3 bg-primary/5 rounded-lg">{recommendation.description}</div>
                    ...
                    <div className="text-sm mt-5 pt-4 border-t border-primary/10">
                      <div className="font-semibold text-foreground mb-2">Styling Tips</div>
                      <div className="text-muted-foreground px-3 py-2 bg-muted/20 rounded-md">
                  ...
                  <div className="mt-6 flex justify-end">
                    <Button
                      ...
                      className="bg-gradient-to-r from-primary to-purple-600 hover:opacity-90 rounded-full px-6"
                      size="default"
                    >
                      {isSavingOutfit ? (
