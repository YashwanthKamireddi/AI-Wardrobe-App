...
const variantStyles: Record<PlinthVariant, string> = {
    gold: `
    bg-gradient-to-br from-[var(--color-gold-muted)] to-[#F5D547]
  ...
  `,
    dark: `
    bg-gradient-to-br from-[var(--color-charcoal)] to-[var(--color-obsidian)]
  ...
  `,
    ...
    border-2 border-[var(--color-gold-muted)]
    shadow-[4px_4px_0px_rgba(212,175,55,0.3)]
    hover:bg-[var(--color-gold-muted)]/10
    active:translate-x-[4px] active:translate-y-[4px] active:shadow-none
  `,
    neon: `
    bg-gradient-to-br from-[var(--color-success)] to-[#32CD32]
    text-[var(--color-obsidian)]
  ...
  `,
    danger: `
    bg-gradient-to-br from-[var(--color-error)] to-[#FF6B7A]
    text-[var(--color-alabaster)]
